  ...
  [
    {
      ...
      snake: {parts:[p(1,1), p(2,1), p(3,1),p(4,1),p(4,2),p(4,3),p(3,3),p(2,3),p(1,3),p(0,3)]},
      food: p(2,2),
    },
    {
      name: "5x4 right in front of food trap",
      snake: {parts:[p(1,2),p(1,1), p(2,1), p(3,1),p(4,1),p(4,2),p(4,3),p(3,3),p(2,3),p(1,3),p(0,3)]},
      food: p(2,2),
    },
    {
    ...
    const path = pathfindGreedy(snake, food, 5, 4);
