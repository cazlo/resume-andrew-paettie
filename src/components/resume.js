...
const Experience = () => (
  <div>
    <h2>
      {' '}
      <FaPieChart /> Professional Experience
    </h2>
    <br />
    <h4>
      Software Engineer at <a href="http://www.coxautoinc.com/">Cox Automotive</a>
    </h4>
    ...
    <ul>
      ...
      <li>
        Simplified complicated configuration logic by searching for tautologies, and removing
        unsatisfiable expressions using MinSAT
      </li>
    ...
    <ul>
      ...
      <li>
        Member of scrum team which develops and maintains microservice applications which aggregate
        and serve vehicle data in a scalable way
      </li>
      <li>
        Set up and maintained system to migrate the source of truth for incentive data to a more
        performant and reliable technology stack
      </li>
      <li>
        Integrated with automated deployment tools to support continuous deployment and integration
      </li>
      <li>
        Installed monitoring and alerting to get increased visibility into key performance
    ...
    <br />
    <h4>
      Dev/OPS intern at <a href="http://www.capitalsoft.com/">CaptialSoft</a>
    </h4>
    <h5>March 2014 - May 2015</h5>
    <ul>
      <li>Generally participated in frontend and backend development</li>
      <li>
        Designed javascript interface for GIS leveraging{' '}
        <a href="http://openlayers.org/">OpenLayers</a>
      </li>
      <li>Designed/updated interface for document management system</li>
      <li>
        Implemented new ant build process which greatly reduced build time and otherwise increased
        productivity
      </li>
  ...
  <Container fluid>
    <Row>
      <Col xs="10" sm="10" md="12">
        <ul className="lead">
          <li>I love creating software and have experience in all facets of development.</li>
          <li>
            I am knowledgeable and proficient with data structures, algorithms, UI and UX
            development, etc.
          </li>
          <li>I focus on results and pay close attention to details.</li>
        </ul>
      </Col>
    </Row>
    <Row>
      <Col>
        <p className="lead">
          I am currently working at Cox Automotive as a Software Engineer/Tech Lead on the Data
          Solutions team. I am always on the lookout for interesting opportunities to experiment
...
const Education = () => (
  <Row>
    ...
    <Col>
      ...
      <ul>
        <li>
          <a href="https://github.com/cazlo/exploring-machine-learning">Machine learning</a>
        </li>
        <li>
          <a href="https://github.com/cazlo/ctf/tree/master/ctf">Artificial Intelligence</a>
        </li>
        <li>
          <a href="https://github.com/cazlo/academic-stuff/tree/master/java/network-stack-sim">
            Advanced Networking
          </a>
        </li>
        <li>
          <a href="https://github.com/cazlo/heli-madness">Software Engineering</a>
        </li>
      </ul>
    </Col>
  </Row>
...
const AlternativeVersions = () => (
  <Container>
    <Row>
      <h2>
        <FaHandGrabO className="text-dark" /> Alternative Resume Formats
      </h2>
    </Row>
    <Row>
      <CardColumns />
