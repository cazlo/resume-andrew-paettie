        ...
        <Row className="justify-content-center">
          <Col xs="12" sm="6" lg="8" className="justify-content-center">
            <Media body>
              ...
              <p className="lead">
                I am an experienced and capable full stack software engineer with leadership
                experience. If you are interested in hiring a full stack software engineer, out my{' '}
          ...
          <Col xs="12" sm="6" md="6" lg="4">
            <img
              src="/img/andrew-paettie-having-fun.jpg"
              alt="Andrew Paettie"
