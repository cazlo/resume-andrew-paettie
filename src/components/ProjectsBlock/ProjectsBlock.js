...
const ProjectCard = props => (
  <Card color="dark">
    {props.imageUrl ? (
      <Media>
        <CardImg top src={props.imageUrl} alt="No Image Available" />
      </Media>
    ) : null}
      ...
      <ButtonGroup>
        {props.githubUrl ? (
          <a href={props.githubUrl}>
            <Button tag="a" className="btn btn-outline-info">
        ...
        {props.siteUrl ? (
          <a href={props.siteUrl}>
            <Button tag="a" className="btn btn-outline-info">
              <FaHashtag className="text-dark" /> Site
            </Button>
          </a>
        ) : null}
      </ButtonGroup>
    ...
    <VerticalTimeline>
      ...
      >
        <h3 className="vertical-timeline-element-title">
          <a>AndrewPaettie.com</a>
        </h3>
        {/* <h4 className='vertical-timeline-element-subtitle'>Miami, FL</h4> */}
        <p>
          A simple portfolio site to show some projects I have done. Implemented with{' '}
          <a href="https://reactjs.com/">react</a>,
          <a href="https://reactstrap.github.io/"> reactstrap</a>, and{' '}
      ...
      >
        ...
        <p>
          An AI agent implemented in Java used to compete against other agents in a simple capture
      ...
      >
        ...
        <p>
          Some homework for an AI class I took, implementing search and constraint solving
      ...
      >
        ...
        <h4 className="vertical-timeline-element-subtitle">University Course</h4>
        <p>
          Some homework for a machine learning class I took, aimed towards implementing and using
